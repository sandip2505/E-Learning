...
export default function ELearningHomePage() {
  ...
  const renderFeaturedCourse = ({ item }: { item: any }) => (
    <TouchableOpacity style={styles.featuredCard} onPress={() => router.push(`/course/${item.id}`)}>
  ...
  const renderContinueLearningItem = ({ item }: { item: any }) => (
    <TouchableOpacity style={styles.continueCard} onPress={() => router.push(`/course/lessons`)}>
