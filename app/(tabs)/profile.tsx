        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.menuContainer}>
                    ...
                    <TouchableOpacity style={styles.menuItem} onPress={() => router.push('/my-course')}>
                    ...
                    <TouchableOpacity style={styles.menuItem} onPress={() => router.push('/support/support')}>
                        <View style={[styles.menuIcon, { backgroundColor: '#FFF2E8' }]}>
                    ...
                    <TouchableOpacity style={styles.menuItem} onPress={() => router.push('/support/privacy')}>
                        <View style={[styles.menuIcon, { backgroundColor: '#F4F4F8' }]}>
                    ...
                    <TouchableOpacity style={styles.menuItem} onPress={() => router.push('/support/terms')}>
                        <View style={[styles.menuIcon, { backgroundColor: '#F4F4F8' }]}>
